...
def fetch_and_save_fiscal_notes(bill, legislature_ordinal, session_ordinal, download_dir):
    """Fetch and save fiscal notes for a bill."""
    ...
    # Also fetch rebuttals if needed
    ...
    # All documents including rebuttals if necessary
    # documents.extend(documents_rebuttals)  # Uncomment if you want to include rebuttals
...
def main():
    ...
    print(f"Completed fetching fiscal notes to {download_dir}")
    return 0
